...
link("http://thi.ng/hdom", "hdom");
link("http://thi.ng/hdom", img("foo.png"));
```
...
-   app state ([thi.ng/atom](https://github.com/thi-ng/umbrella/tree/master/packages/atom))
-   data transformation via transducers ([thi.ng/transducers](https://github.com/thi-ng/umbrella/tree/master/packages/transducers))
-   reactive streams (via transducers) ([thi.ng/rstream](https://github.com/thi-ng/umbrella/tree/master/packages/rstream), [thi.ng/rstream-log](https://github.com/thi-ng/umbrella/tree/master/packages/rstream-log))

Examples:

-   [Todo list](https://demo.thi.ng/umbrella/todo-list/) with Undo/Redo feature ([source](https://github.com/thi-ng/umbrella/tree/master/examples/todo-list))
-   [Component generation from JSON](https://demo.thi.ng/umbrella/json-components/) (w/ realtime editor/preview, [source](https://github.com/thi-ng/umbrella/tree/master/examples/json-components))
-   [SVG particle system](https://demo.thi.ng/umbrella/svg-particles/) ([source](https://github.com/thi-ng/umbrella/tree/master/examples/svg-particles))
-   [Stress test](https://demo.thi.ng/umbrella/hdom-benchmark/) ([source](https://github.com/thi-ng/umbrella/tree/master/examples/hdom-benchmark))
